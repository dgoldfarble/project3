...
VL_MODULE(VMIPS_MIPS) {
  ...
  public:
    ...
    static void	_combo__TOP__v__20(VMIPS__Syms* __restrict vlSymsp);
    static void	_combo__TOP__v__22(VMIPS__Syms* __restrict vlSymsp);
    static void	_combo__TOP__v__6(VMIPS__Syms* __restrict vlSymsp);
    static void	_initial__TOP__v(VMIPS__Syms* __restrict vlSymsp);
    static void	_multiclk__TOP__v__14(VMIPS__Syms* __restrict vlSymsp);
